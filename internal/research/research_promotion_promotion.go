...
// NewPromotionService constructs the research promotion authenticated command boundary.
...
// machine. Sandbox integration remains unavailable in multi-strategy research.
