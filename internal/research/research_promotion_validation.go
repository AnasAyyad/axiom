...
// EvidenceSource is one immutable run result used by a research promotion suite.
...
// ValidationSuiteManifest is immutable research promotion promotion evidence. Maturity remains
...
// BuildValidationSuite validates, computes, and seals one research promotion suite against its
...
// ValidateValidationSuiteCanonical proves exact stored research promotion suite bytes.
