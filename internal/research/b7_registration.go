...
// ValidationSuiteContract is the canonical B7 multi-strategy evidence schema.
const ValidationSuiteContract = "multi-strategy-validation.v1"

// ExperimentRegistrationContract is the canonical B7 preregistration schema.
...
// ValidateExperimentRegistrationCanonical proves exact stored B7
