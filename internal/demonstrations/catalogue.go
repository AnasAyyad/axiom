...
func Catalogue() []Scenario {
	return []Scenario{{
		...
		ID: TriangularArbitrageID, Title: "Triangular Arbitrage basics", Description: "A synthetic three-conversion walkthrough that shows allocator and central-risk approval, deterministic virtual fills, accounting, reconciliation, and an insufficient-fee-capacity rejection.", StrategyID: "triangular-arbitrage", StrategyVersion: "triangular-arbitrage@1.0.0", ExpectedOutcomes: []string{"Exact three-conversion candidate", "Allocator and central-risk approval", "Virtual sequential orders and fills", "Accounting and reconciliation evidence", "Insufficient-fee-capacity rejection"},
	}, {
		ID: CrossExchangeArbitrageID, Title: "Cross-Exchange Arbitrage basics", Description: "A synthetic two-venue walkthrough that shows allocator and central-risk approval, concurrent virtual fills, accounting, reconciliation, and an uneconomic-restoration rejection.", StrategyID: "cross-exchange-arbitrage", StrategyVersion: "cross-exchange-arbitrage@1.0.0", ExpectedOutcomes: []string{"Coherent two-venue closed-cycle candidate", "Allocator and central-risk approval", "Virtual concurrent orders and fills", "Accounting and reconciliation evidence", "Uneconomic-restoration rejection"},
	}}
}
