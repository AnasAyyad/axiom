...
func (handler *handler) registerMultiExchangeConsoleCommands(mux *http.ServeMux) {
...
func (handler *handler) scheduleReplayFault(
	...
	if !validMultiExchangeConsoleReplayFault(body) {
...
func validMultiExchangeConsoleReplayFault(value generated.ReplayFaultRequest) bool {
