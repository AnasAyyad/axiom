...
func TestC6SmokeProducesNonQualifiedImmutableEvidence(t *testing.T) {
	at := time.Date(2026, 7, 30, 10, 0, 0, 0, time.UTC)
...
func TestC6FailsClosedOnProductionTargetAndCap(t *testing.T) {
	at := time.Date(2026, 7, 30, 10, 0, 0, 0, time.UTC)
	clock := &testClock{now: at}
...
func TestC6FailsClosedOnPositiveMemoryLeakTrend(t *testing.T) {
	at := time.Date(2026, 7, 30, 10, 0, 0, 0, time.UTC)
...
func TestC6PersistsRuntimeDerivedRecoveryLifecycleBetweenSamples(t *testing.T) {
	at := time.Date(2026, 7, 30, 10, 0, 0, 0, time.UTC)
	deadline := at.Add(2 * time.Minute)
	...
	sample.Accounts = []AccountObservation{{
		...
		RecoveryEvents: []AccountRecoveryEvent{
			{
...
func TestC6AllowsDisconnectedStreamOnlyBeforeItsFirstCleanCheck(t *testing.T) {
...
func TestC6ActiveRecoveryPastDeadlineFailsExpired(t *testing.T) {
	at := time.Date(2026, 7, 30, 10, 0, 0, 0, time.UTC)
...
func TestC6FailsClosedForEverySampleInvariant(t *testing.T) {
	for _, test := range c6SampleInvariantCases {
...
func TestC6FailedChaosCannotQualify(t *testing.T) {
	at := time.Date(2026, 7, 30, 10, 0, 0, 0, time.UTC)
	evidence, err := (Runner{
		Clock: &testClock{now: at},
...
func TestC6FormalRequiresExactDurationCleanSourceAndTwoEnvironments(t *testing.T) {
...
func TestC6DeterministicChaosCoversEveryRequiredScenario(t *testing.T) {
	at := time.Date(2026, 7, 30, 10, 0, 0, 0, time.UTC)
