...
func TestRunnerFailsOnCorrectnessDefectAndCannotQualify(t *testing.T) {
	...
	evidence, err := runner.Run(context.Background(), configuration)
	if err == nil || err.Error() != "d5_qualification_failed" {
...
func testConfig(t *testing.T) Config {
	...
	return Config{Enabled: true, Identity: Identity{RunID: "d5-smoke-20260804", Mode: ModeSmoke,
		...
		FaultSchedule: FaultSchedule{SchemaVersion: "axiom.d5.fault-schedule.v1", Faults: []FaultSpec{
