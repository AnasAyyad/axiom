...
// DefaultMultiStrategyConfiguration returns the current credential-free public exchange,
// strategy and advisory graphs while preserving earlier compatibility projections.
func DefaultMultiStrategyConfiguration() Configuration {
	...
	configuration.Rebalancing = defaultRebalancingConfiguration()
	return configuration
}

// PublicExchanges returns the ordered recorder graph, projecting legacy TrendFoundation
