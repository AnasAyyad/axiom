...
func clearRuntimeEnvironment(t *testing.T) {
	...
	for _, key := range []string{
		...
		"RECORDER_ROOT", "RECORDER_FLUSH_INTERVAL", "RECORDER_PRESSURE_SAMPLE_INTERVAL", "RECORDER_MIN_FREE_BYTES", "RECORDER_CRITICAL_FREE_BYTES", "MARKET_EVENT_QUEUE_CAPACITY", "ORDER_BOOK_RETAINED_DEPTH", "COLLECTOR_REGION",
...
func defaultForUnset(key string) string {
	defaults := map[string]string{
		...
		"RECORDER_PRESSURE_SAMPLE_INTERVAL": "15s", "RECORDER_MIN_FREE_BYTES": "10737418240",
		"RECORDER_CRITICAL_FREE_BYTES": "5368709120",
