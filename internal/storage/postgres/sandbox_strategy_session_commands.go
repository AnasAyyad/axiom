...
WHERE strategy.id=$1
  ...
  AND EXISTS (
    SELECT 1 FROM v1c_sandbox_arms arm
...
func (store *A11ConsoleStore) StartSandboxStrategySession(
	ctx context.Context,
	...
	if err != nil || validateC6Consumed(principal, consumed, authentication.PurposeSandboxArm, body.Reason) != nil {
		return generated.CommandAccepted{}, console.ErrPrecondition
	}
	pending, err := store.beginC6Command(ctx, principal, key, "sandbox.strategy_session_start",
	...
	if errors.Is(err, pgx.ErrNoRows) {
		store.rejectC6Command(ctx, pending, "sandbox_strategy_session_start_rejected")
		return generated.CommandAccepted{}, console.ErrPrecondition
	}
	if err != nil {
		return generated.CommandAccepted{}, err
	}
	return store.completeC6Command(ctx, pending, principal, "sandbox.strategy_session_start", id,
...
func (store *A11ConsoleStore) StopSandboxStrategySession(
	ctx context.Context,
	principal authentication.Principal,
	id, key string,
	...
	pending, err := store.beginC6Command(ctx, principal, key, "sandbox.strategy_session_stop",
		"sandbox_strategy_session", id, body.Reason, expected,
	...
	if errors.Is(err, pgx.ErrNoRows) {
		store.rejectC6Command(ctx, pending, "sandbox_strategy_session_stop_rejected")
		return generated.CommandAccepted{}, console.ErrPrecondition
	}
	if err != nil {
		return generated.CommandAccepted{}, err
	}
	return store.completeC6Command(ctx, pending, principal, "sandbox.strategy_session_stop", id,
