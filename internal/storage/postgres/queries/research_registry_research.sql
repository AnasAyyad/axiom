-- name: InsertResearchRegistryStrategyDefinition :one
INSERT INTO strategy_definitions (id, name, family)
VALUES ($1, $2, $3)
RETURNING *;

-- name: InsertResearchRegistryStrategyVersion :one
...
-- name: InsertResearchRegistryStrategyParameter :one
...
-- name: InsertResearchRegistryExperimentRegistration :one
