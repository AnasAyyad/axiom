-- name: RegisterTriangularArbitrageClaimResource :exec
SELECT register_triangular_arbitrage_claim_resource($1,$2,$3,$4,$5,$6,$7);
...
-- name: ClaimTriangularArbitrageResources :exec
SELECT claim_triangular_arbitrage_resources(
...
-- name: SettleTriangularArbitrageClaimGroup :exec
SELECT settle_triangular_arbitrage_claim_group(
...
-- name: CloseTriangularArbitrageClaimGroup :exec
SELECT close_triangular_arbitrage_claim_group($1,$2,$3,$4,$5);
...
-- name: GetTriangularArbitrageClaimGroup :one
SELECT * FROM triangular_arbitrage_claim_groups WHERE id = $1;

-- name: ListTriangularArbitrageClaimItems :many
SELECT * FROM triangular_arbitrage_claim_items WHERE group_id = $1 ORDER BY resource_id;
