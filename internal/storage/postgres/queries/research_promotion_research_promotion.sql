-- name: InsertResearchPromotionExperimentPreregistration :one
...
-- name: InsertResearchPromotionValidationSuite :one
...
-- name: InsertResearchPromotionChampionChallengerReport :one
...
-- name: GetResearchPromotionExperimentPreregistration :one
SELECT * FROM research_promotion_experiment_preregistrations WHERE id = $1;

-- name: GetResearchPromotionValidationSuite :one
SELECT * FROM research_promotion_validation_suites WHERE id = $1;

-- name: GetResearchPromotionMaturityState :one
