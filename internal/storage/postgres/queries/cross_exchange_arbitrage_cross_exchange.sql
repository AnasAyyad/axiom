-- name: RegisterCrossExchangeArbitrageClaimResource :exec
SELECT register_cross_exchange_arbitrage_claim_resource($1,$2,$3,$4,$5,$6,$7);
...
-- name: ClaimCrossExchangeArbitrageResources :exec
SELECT claim_cross_exchange_arbitrage_resources(
...
-- name: SettleCrossExchangeArbitrageClaimGroup :exec
SELECT settle_cross_exchange_arbitrage_claim_group(
...
-- name: CloseCrossExchangeArbitrageClaimGroup :exec
SELECT close_cross_exchange_arbitrage_claim_group($1,$2,$3,$4,$5);
...
-- name: GetCrossExchangeArbitrageClaimGroup :one
SELECT * FROM cross_exchange_arbitrage_claim_groups WHERE id = $1;

-- name: ListCrossExchangeArbitrageClaimItems :many
SELECT * FROM cross_exchange_arbitrage_claim_items WHERE group_id = $1 ORDER BY resource_id;
