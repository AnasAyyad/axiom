...
func b8SnapshotRevision(ctx context.Context, pool *pgxpool.Pool) (string, error) {
	var revision int64
...
func b8Quality(source string, observed time.Time, confidence generated.QualityEvidenceConfidence,
...
func b8Freshness(now, observed time.Time) generated.QualityEvidenceFreshness {
...
func decodeB8StringCursor(codec console.CursorCodec, scope, cursor string) (string, error) {
	return codec.Decode(scope, cursor)
}

func encodeB8StringCursor(codec console.CursorCodec, scope, position string) string {
	return codec.Encode(scope, position)
}

func b8PositiveAge(now, observed time.Time) string {
...
func decodeB8TimeCursor(codec console.CursorCodec, scope, cursor string) (time.Time, string, error) {
...
func encodeB8TimeCursor(codec console.CursorCodec, scope string, recordedAt time.Time, id string) string {
