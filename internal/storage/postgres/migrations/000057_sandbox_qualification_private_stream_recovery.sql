...
-- Sandbox qualification private-stream recovery
...
ALTER TABLE sandbox_runtime_engine_runtime_events
  DROP CONSTRAINT sandbox_runtime_engine_runtime_events_kind_check,
  ADD CONSTRAINT sandbox_runtime_engine_runtime_events_kind_check CHECK (kind IN (
...
ALTER TABLE sandbox_qualification_recovery_events
...
ALTER TABLE sandbox_qualification_failures
  DROP CONSTRAINT sandbox_qualification_failures_reason_check,
  ADD CONSTRAINT sandbox_qualification_failures_reason_check CHECK (reason IN (
