...
ALTER TABLE v1c_c6_qualification_samples
...
CREATE INDEX v1c_c6_recovery_events_run_account_time
  ON v1c_c6_recovery_events(run_id,account_id,occurred_at DESC,id DESC);

CREATE TRIGGER v1c_c6_recovery_events_immutable
  BEFORE UPDATE OR DELETE ON v1c_c6_recovery_events
