...
func (store *SandboxRuntimeDispatcherStore) RecordAuthenticatedRequest(
	ctx context.Context,
	...
	if err != nil {
		return fmt.Errorf("sandbox_runtime_authenticated_evidence_encode_failed")
	}
...
INSERT INTO sandbox_runtime_authenticated_request_evidence(
  ...
  request_hash,configuration_id,recorded_at
		...
		return fmt.Errorf("sandbox_runtime_authenticated_evidence_insert_failed")
	}
	return nil
}

var _ exchangecontracts.AuthenticatedEvidenceSink = (*SandboxRuntimeDispatcherStore)(nil)
