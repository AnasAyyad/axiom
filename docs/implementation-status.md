...
| A6    | In progress | Public exchange contracts, capability boundary, deterministic controls, emulator, and fixtures    | A5 verified and merged to `origin/main`; implementation is active on `a6-candidate`                           |
