...
| AX-V1D-D06-008 | Keep final certification default-off | `cmd/d6-certify` and `make d6-final-certification` require explicit enablement and clean exact build | default-off test passes; command is expected to reject current state |
