...
binance-ethbtc-trigger-live-probe: ## Compare ETHBTC-triggered same-exchange as-of limits; experimental and non-qualifying.
	@test "$(AXIOM_BINANCE_ETHBTC_TRIGGER_LIVE)" = "1" || { echo "AXIOM_BINANCE_ETHBTC_TRIGGER_LIVE=1 is required" >&2; exit 1; }
	@AXIOM_BINANCE_ETHBTC_TRIGGER_LIVE=1 \
		AXIOM_BINANCE_ETHBTC_TRIGGER_DURATION="$(AXIOM_BINANCE_ETHBTC_TRIGGER_DURATION)" \
