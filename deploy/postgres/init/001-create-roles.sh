...
psql \
  ...
  --set=operational_readiness_user="$POSTGRES_OPERATIONAL_READINESS_USER" \
...
SELECT
  ...
  rtrim(pg_read_file('/run/secrets/postgres_operational_readiness_password'), E'\r\n') AS operational_readiness_password,
...
SELECT format('CREATE ROLE %I LOGIN PASSWORD %L', :'operational_readiness_user', :'operational_readiness_password')
WHERE NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = :'operational_readiness_user')
\gexec
...
\gexec
SELECT format('ALTER ROLE %I PASSWORD %L', :'operational_readiness_user', :'operational_readiness_password')
\gexec
...
GRANT CONNECT ON DATABASE :"DBNAME" TO :"migrator_user", :"runtime_user", :"recorder_user", :"backup_user", :"readonly_user", :"operational_readiness_user", :"binance_engine_user", :"bybit_engine_user", :"sandbox_qualification_user";
GRANT USAGE, CREATE ON SCHEMA public TO :"migrator_user";
GRANT USAGE ON SCHEMA public TO :"runtime_user", :"recorder_user", :"backup_user", :"readonly_user", :"operational_readiness_user", :"binance_engine_user", :"bybit_engine_user", :"sandbox_qualification_user";
